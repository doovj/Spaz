...
public class createOrEditAlert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repeatModes = new String[]{"Tidak", "Perjam", "Perhari", "Perminggu", "Perbulan", "Pertahun"};
        repeatMode = 0;
        ...
        if (id > 0) {
            ...
            long timeInMilliseconds = cursor.getLong(cursor.getColumnIndex(Database.DB_COLUMN_TIME));
            repeatMode = cursor.getInt(cursor.getColumnIndex(Database.DB_COLUMN_FREQUENCY));
        ...
        item1.put("title", "Jam berapa mau diingatkan");
        item1.put("subtext", time);
        item2.put("title", "Tanggal berapa mau diingatkan");
        item2.put("subtext", date);
        item3.put("title", "Ulangi");
