...
public class AlarmService extends IntentService {
    ...
    private void execute(String action, int id, boolean deletedFromMain) {
        ...
        intent.putExtra("id", cursor.getInt(cursor.getColumnIndex(Database.DB_COLUMN_ID)));
        intent.putExtra("title", cursor.getString(cursor.getColumnIndex(Database.DB_COLUMN_NAMA)));
        intent.putExtra("msg", cursor.getString(cursor.getColumnIndex(Database.DB_COLUMN_KONTEN)));
