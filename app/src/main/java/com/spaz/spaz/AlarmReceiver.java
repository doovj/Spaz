...
public class AlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int frequency = cursor.getInt(cursor.getColumnIndex(Database.DB_COLUMN_FREQUENCY));
        Calendar time = Calendar.getInstance();
        time.setTimeInMillis(cursor.getLong(cursor.getColumnIndex(Database.DB_COLUMN_TIME)));
        ...
        Intent result = new Intent(context, Action.class);
        result.putExtra("ID", id);
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);
        stackBuilder.addParentStack(Action.class);
